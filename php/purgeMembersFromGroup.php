...
//        var_dump(isset($argv));
    ...
    if ( defined('STDIN') ) {
        ...
        if ( $dmem_debug == 1 ) {
            ...
            print "1z - GroupID $GroupID" . PHP_EOL;
        }
    }
    ...
    if ( strlen($sid) == 0 ) {
        print "ERROR: 03L missing login information." . PHP_EOL;
